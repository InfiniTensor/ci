#!/bin/bash
full_model_list=(DeepSeek-R1:8 DeepSeek-V3-0324:8 Qwen3-235B-A22B-FP8:4 DeepSeek-R1-AWQ:8 DeepSeek-R1-Distill-Qwen-1.5B:1 DeepSeek-R1-Distill-Qwen-7B:1 DeepSeek-R1-Distill-Qwen-14B:1 DeepSeek-R1-Distill-Qwen-32B:1 DeepSeek-R1-Distill-Llama-8B:1 DeepSeek-R1-Distill-Llama-70B:4 Meta-Llama-3.1-8B-Instruct:1 Meta-Llama-3.1-70B-Instruct:4 
...
for item in ${full_model_list[@]};do
    ...
    eval_1="$curr_dir/$result_dir/$(date +"%Y%m%d")_${model}_DynamicSplitFuseV2_use-prefix-cache_evalscope_1.log"
    eval_2="$curr_dir/$result_dir/$(date +"%Y%m%d")_${model}_DynamicSplitFuseV2_use-prefix-cache_evalscope_2.log"
    sglang="$curr_dir/$result_dir/$(date +"%Y%m%d")_${model}_DynamicSplitFuseV2_use-prefix-cache_SGLang_3.log"
    if [ -f "$eval_1" ];then
