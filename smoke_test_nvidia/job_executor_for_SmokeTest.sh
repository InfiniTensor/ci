...
ret=`docker ps -a | grep siginfer_nvidia_SmokeTest`
if [ $? -eq 0 ]; then
  docker stop siginfer_nvidia_SmokeTest
  docker rm siginfer_nvidia_SmokeTest
fi
...
EXEC_COMMAND="docker run --name=siginfer_nvidia_SmokeTest \
    --gpus all \
    --privileged \
    --cap-add=ALL \
    --network host \
...
if [ $model == "DeepSeek-R1" ]; then
    ...
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --model llama --tokenizer /home/weight/Qwen3/Qwen3-235B-A22B-FP8 -ep 4 --port 8000 --platform-type nvidia $USE_PREFIX_CACHE --schedule-policy $SCHEDULE_POLICY --max-num-batched-tokens 2048 --master-port 27642 --nnodes 1 --node-rank 0 --gpu-memory-utilization 0.98 --prometheus-port 8001 $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --model llama --tokenizer /home/weight/Qwen3/Qwen3-235B-A22B-FP8 -ep 4 --port 8000 --platform-type nvidia $USE_PREFIX_CACHE --schedule-policy $SCHEDULE_POLICY --max-num-batched-tokens 2048 --master-port 27642 --nnodes 1 --node-rank 0 --gpu-memory-utilization 0.98 --prometheus-port 8001 $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "DeepSeek-R1-awq" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /data/weight/DeepSeek-R1-awq/ --expert-parallel-size 8 --port 8000 --max-num-batched-tokens 2048 --gpu-memory-utilization 0.98 --platform-type nvidia $USE_PREFIX_CACHE --use-marlin --use-marlin-wna16 --weight-dtype=FP16 --prometheus-port 8001 $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /data/weight/DeepSeek-R1-awq/ --expert-parallel-size 8 --port 8000 --max-num-batched-tokens 2048 --gpu-memory-utilization 0.98 --platform-type nvidia $USE_PREFIX_CACHE --use-marlin --use-marlin-wna16 --weight-dtype=FP16 --prometheus-port 8001 $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "DeepSeek-R1-Distill-Qwen-32B" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/DeepSeek-R1-Distill-Qwen-32B -tp 1 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/DeepSeek-R1-Distill-Qwen-32B -tp 1 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "DeepSeek-R1-Distill-Llama-70B" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/DeepSeek-R1-Distill-Llama-70B -tp 4 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/DeepSeek-R1-Distill-Llama-70B -tp 4 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "Meta-Llama-3.1-70B-Instruct" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Meta-Llama-3.1-70B-Instruct -tp 4 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Meta-Llama-3.1-70B-Instruct -tp 4 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
    ...
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/QwQ-32B -tp 2 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/QwQ-32B -tp 2 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "Qwen2.5-32B-Instruct-AWQ" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Qwen2.5-32B-Instruct-AWQ -tp 1 --disable-turbomind --use-marlin --weight-dtype=FP16 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Qwen2.5-32B-Instruct-AWQ -tp 1 --disable-turbomind --use-marlin --weight-dtype=FP16 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "QwQ-32B-AWQ" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/QwQ-32B-AWQ -tp 1 --weight-dtype=FP16 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/QwQ-32B-AWQ -tp 1 --weight-dtype=FP16 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "Qwen3-235B-A22B" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --model llama --tokenizer /home/weight/Qwen3/Qwen3-235B-A22B -ep 8 --port 8000 --platform-type nvidia --schedule-policy $SCHEDULE_POLICY --max-num-batched-tokens 2048 --master-port 27642 --nnodes 1 --node-rank 0 --gpu-memory-utilization 0.98 --prometheus-port 8001 $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --model llama --tokenizer /home/weight/Qwen3/Qwen3-235B-A22B -ep 8 --port 8000 --platform-type nvidia --schedule-policy $SCHEDULE_POLICY --max-num-batched-tokens 2048 --master-port 27642 --nnodes 1 --node-rank 0 --gpu-memory-utilization 0.98 --prometheus-port 8001 $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "Qwen2.5-72B-Instruct-AWQ" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Qwen2.5-72B-Instruct-AWQ -tp 1 --disable-turbomind --use-marlin --weight-dtype=FP16 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Qwen2.5-72B-Instruct-AWQ -tp 1 --disable-turbomind --use-marlin --weight-dtype=FP16 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
elif [ $model == "Qwen2.5-72B-Instruct" ]; then
    echo "SIG_LOG_LEVEL='warn,console_logger=info' ./start.sh --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Qwen2.5-72B-Instruct -tp 4  --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION"
    EXEC_COMMAND+=" --schedule-policy $SCHEDULE_POLICY --master-port 27642 --nnodes 1 --node-rank 0 --model llama --tokenizer /home/weight/Qwen2.5-72B-Instruct -tp 4  --max-num-batched-tokens 8192 --gpu-memory-utilization 0.9 --port 8000 --prometheus-port 8001 --platform-type nvidia $USE_PREFIX_CACHE $SWAP_SPACE_OPTION > $LOG_NAME 2>&1 &"
fi
