...
def main():
    ...
    summary = read_and_format_summary(log_file_path, "x86_64-nvidia-A100:" + docker_image_version)
    send_summary_to_server("x86_64-nvidia-A100:" + docker_image_version, None, summary)
